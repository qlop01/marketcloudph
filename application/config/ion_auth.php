...
*/
	 ...
	 */
	$config['site_title']		   = "marketcloudph.com";
	
	/**
	 * Email Title for sending emails
	 */
	$config['email_title']		   = "MarketCloudph";
	
	/**
	 * Email Title for sending emails
	 */
	$config['from_title']		   = "MarketCloudph Webmaster";
	
	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "marketcloudph@gmail.com";
	 ...
	 * id not required.
	 **/
	$config['columns']             = array('first_name', 'last_name', 'company', 'phone','location');
